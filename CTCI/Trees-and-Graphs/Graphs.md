...
**This might seem like a minor difference, but it's not. It's huge. Recall that (K^(d/2))* (K^(d/2)) = K^d. The bidirectional search is actually faster by a factor of K^(d/2).** <br />
